...
C
      ...
      CALL MZTRANS(A,B,NNZ*NNX,NPU,NY)
      CALL ZTRANS2(B,A,NNZ,NNX*NY,NPU)
     ...
     1                  MPI_DOUBLE_COMPLEX,ICOMM,IERR)
      CALL MZTRANS(A,B,NNX,NY*NNZ,NPU)
      RETURN
      END
...
C
      IF (IOPT .EQ. 1) THEN
        CALL MZTRANS(A,B,NNX,NPU,NY*NNZ)
        CALL MPI_ALLTOALL(B,NN/NPU,MPI_DOUBLE_COMPLEX,A,NN/NPU,
     1                    MPI_DOUBLE_COMPLEX,ICOMM,IERR)
      END IF
C
      ...
      CALL MPI_ALLTOALL(A,NN/NPU,MPI_DOUBLE_COMPLEX,B,NN/NPU,
     1                  MPI_DOUBLE_COMPLEX,ICOMM,IERR)
      CALL ZTRANS2(B,A,NNX*NY,NNZ,NPU)
      CALL MZTRANS(A,B,NNZ*NNX,NY,NPU)
